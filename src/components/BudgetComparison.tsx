                    ...
                    <div id="changes-content" ref={budgetChangeSummaryRef}>
                      <div className="mb-6 p-4 bg-slate-50 border border-slate-200 rounded-md" ref={changesContentRef}>
                        ...
                        <p className="text-slate-700 mb-2 text-left">
                          Berdasarkan hasil analisis revisi anggaran, total pagu anggaran semula sebesar Rp {totalSemula.toLocaleString('id-ID')} mengalami perubahan menjadi Rp {totalMenjadi.toLocaleString('id-ID')}, dengan selisih Rp {totalSelisih.toLocaleString('id-ID')} atau {totalSelisih === 0 ? 'tetap' : totalSelisih > 0 ? 'meningkat' : 'menurun'}.
                        </p>
                        <p className="text-slate-700 mb-2 text-left">
